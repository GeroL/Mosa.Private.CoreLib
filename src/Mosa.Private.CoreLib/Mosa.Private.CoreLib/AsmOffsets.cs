...
static class AsmOffsets
{
    ...
    internal const int SIZEOF__ExInfo = 0x270;
    ...
    internal const int OFFSETOF__ExInfo__m_notifyDebuggerSP = 0x260;
    ...
    internal const int SIZEOF__StackFrameIterator = 0x240;
    ...
    internal const int OFFSETOF__StackFrameIterator__m_pPreviousTransitionFrame = 0x230;
