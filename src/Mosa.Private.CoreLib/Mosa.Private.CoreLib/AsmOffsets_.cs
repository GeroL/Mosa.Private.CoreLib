...
partial class AsmOffsets2
{
    ...
    public const int OFFSETOF__StackFrameIterator__m_OriginalControlPC = 0xa4;
    public const int OFFSETOF__StackFrameIterator__m_pPreviousTransitionFrame = 0xa8;
#else // TARGET_64BIT
