...
MANIFEST_BASE_NAME="Mosa.sdk.manifest"
...
function install_mosaworkload() {
    ...
    mkdir -p $SDK_MANIFESTS_DIR/Mosa.sdk
    cp -f $TMPDIR/unzipped/data/* $SDK_MANIFESTS_DIR/Mosa.sdk/

    if [ ! -f $SDK_MANIFESTS_DIR/Mosa.sdk/WorkloadManifest.json ]; then
